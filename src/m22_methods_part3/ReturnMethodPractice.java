...
/*
Create a method names calculate that passes the following three parameters:
double num1
char mathOperator
double num2

    The method will return calculation result of the two numbers by using the given
    math operator.
